...
--
-- Host: localhost    Database: bestioles-auth
-- ------------------------------------------------------
...
CREATE TABLE `user_` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_595avk25fuwifq27av9e3ixqn` (`login`),
  KEY `FKoyjlmh68os16366i2nkcdb7f4` (`authority_name`),
  CONSTRAINT `FKoyjlmh68os16366i2nkcdb7f4` FOREIGN KEY (`authority_name`) REFERENCES `authority` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_` VALUES (1,'admin','$2a$10$d3LZbfJilyBpw9QQYglRpum..NoftYSkd3Rix/M.VHFrMFsBXNvKK','ROLE_ADMIN'),(2,'user','$2a$10$gxRoLb0JUyRFpVhms71uyOjmXT06eISbnDNIrQAYNQK6vta7JQe6W','ROLE_USER'),(3,'test','$2a$10$gxRoLb0JUyRFpVhms71uyOjmXT06eISbnDNIrQAYNQK6vta7JQe6W','ROLE_USER');
...
-- Dump completed on 2022-07-26  9:19:50
